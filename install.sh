...
sudo cp aws-launch-debian8/unix-conf/sources-lists.conf /etc/apt/sources.list 
sudo apt-get update
...
sudo bash -c 'cat aws-launch-debian8/zabbix-conf/zabbix_agentd.conf > /etc/zabbix/zabbix_agentd.conf'
echo "ajustes no .bashrc - history"
sudo bash -c 'cat aws-launch-debian8/unix-conf/bashrc.conf >> /root/.bashrc'
sudo bash -c 'cat aws-launch-debian8/unix-conf/bashrc.conf >> /home/admin/.bashrc'
sudo bash -c 'cat aws-launch-debian8/unix-conf/bashrc.conf >> /etc/skel/.bashrc'
